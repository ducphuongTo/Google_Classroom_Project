...
<body>
  <?php
    $resultGetClasswork = getClasswork($_GET['classworkID']);
    ...
    if (isset($_POST['content']) and isset($_POST['title']))
    {
      ...
      {
        $resultUpdate = updateClasswork($_GET['classworkID'], $title, $content);
      ...
      $title = $resultGetClasswork['data']['title'];
      $content = $resultGetClasswork['data']['content'];
    }
  ?>
          ...
          <div class="col-lg-6">
            ...
            <form action="" class="addFeed" method="post">
                <div class="row">
                  ...
                  <div class="col-75">
                    <input class="inputClasswork" type="text" name="title" placeholder="Title" value="<?=$title?>">
                  </div>
                </div>
