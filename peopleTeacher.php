                        ...
                        <div class="modal fade" id='confirm<?=$row['id']?>'>
                            <div class="modal-dialog">
                              <div class="modal-content">
                                  ...
                                  Bạn có chắc rằng muốn xóa học viên này không?
                                  </div>
                              
                                  <div class="modal-footer">
                                      <a class="btn btn-primary btn-sm" href="peopleTeacher.php?id=<?=$_GET['id']?>&teacherEmail=<?=$_GET['teacherEmail']?>&removeStudent=<?=$row['studentemail']?>">có</a>
                                      <a class="btn btn-primary btn-sm" href="peopleTeacher.php?id=<?=$_GET['id']?>&teacherEmail=<?=$_GET['teacherEmail']?>">Không</a>
                                  </div>            
                                </div>
                            </div>
                      </div>
