            ...
            ?>
                    ...
                    <div class="modal fade" id="confirm<?=$row['id']?>">
                        ...
                        <div class="modal-content">
                            ...
                            <h4 class="modal-title">Xóa lớp hoc.</h4>
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-primary btn-sm" href="hometeacher.php?username=<?=$email?>&removeClass=<?=$row['id']?>">có</a>
                                <a class="btn btn-primary btn-sm" href="hometeacher.php?username=<?=$email?>">Không</a>
                            </div>            
                            </div>
                        </div>
                    </div>
